...
def main():
    ...
    if not weight_file:
        weight_file = get_file("checkpoints_final/weights.78-3.51.hdf5", pretrained_model, cache_subdir="pretrained_models",
    ...
    dataset_root = Path(__file__).parent.joinpath("appa-real", "appa-real-release/appa-real-release")
